...
# direct methods
.method public constructor <init>(Lextern/okhttp3/Cache;Lextern/okhttp3/internal/cache/DiskLruCache$Editor;)V
    .locals 2
    .param p2, "editor"    # Lextern/okhttp3/internal/cache/DiskLruCache$Editor;
...
.method static synthetic access$700(Lextern/okhttp3/Cache$CacheRequestImpl;)Z
    .locals 1
    .param p0, "x0"    # Lextern/okhttp3/Cache$CacheRequestImpl;

    .prologue
    .line 430
    iget-boolean v0, p0, Lextern/okhttp3/Cache$CacheRequestImpl;->done:Z

    return v0
.end method

.method static synthetic access$702(Lextern/okhttp3/Cache$CacheRequestImpl;Z)Z
    .locals 0
    .param p0, "x0"    # Lextern/okhttp3/Cache$CacheRequestImpl;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 430
    iput-boolean p1, p0, Lextern/okhttp3/Cache$CacheRequestImpl;->done:Z
...
.method public abort()V
    ...
    .prologue
    .line 455
    iget-object v1, p0, Lextern/okhttp3/Cache$CacheRequestImpl;->this$0:Lextern/okhttp3/Cache;
    ...
    iput-boolean v0, p0, Lextern/okhttp3/Cache$CacheRequestImpl;->done:Z

    .line 460
    iget-object v0, p0, Lextern/okhttp3/Cache$CacheRequestImpl;->this$0:Lextern/okhttp3/Cache;

    # operator++ for: Lextern/okhttp3/Cache;->writeAbortCount:I
    invoke-static {v0}, Lextern/okhttp3/Cache;->access$908(Lextern/okhttp3/Cache;)I
