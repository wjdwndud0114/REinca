.class final Lextern/okio/Okio$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lextern/okio/Okio;->source(Ljava/io/InputStream;Lextern/okio/Timeout;)Lextern/okio/Source;
.end annotation
...
# direct methods
.method constructor <init>(Lextern/okio/Timeout;Ljava/io/InputStream;)V
    .locals 0

    .prologue
    .line 126
    iput-object p1, p0, Lextern/okio/Okio$2;->val$timeout:Lextern/okio/Timeout;

    iput-object p2, p0, Lextern/okio/Okio$2;->val$in:Ljava/io/InputStream;
...
.method public close()V
    ...
    .prologue
    .line 146
    iget-object v0, p0, Lextern/okio/Okio$2;->val$in:Ljava/io/InputStream;
...
.method public read(Lextern/okio/Buffer;J)J
    ...
    :cond_1
    :try_start_0
    iget-object v4, p0, Lextern/okio/Okio$2;->val$timeout:Lextern/okio/Timeout;

    invoke-virtual {v4}, Lextern/okio/Timeout;->throwIfReached()V
    ...
    iget-object v4, p0, Lextern/okio/Okio$2;->val$in:Ljava/io/InputStream;
    ...
    invoke-static {v1}, Lextern/okio/Okio;->isAndroidGetsocknameError(Ljava/lang/AssertionError;)Z
...
.method public timeout()Lextern/okio/Timeout;
    ...
    .prologue
    .line 150
    iget-object v0, p0, Lextern/okio/Okio$2;->val$timeout:Lextern/okio/Timeout;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lextern/okio/Okio$2;->val$in:Ljava/io/InputStream;
