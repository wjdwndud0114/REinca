.class public final Lextern/okhttp3/internal/tls/OkHostnameVerifier;
...
.field public static final INSTANCE:Lextern/okhttp3/internal/tls/OkHostnameVerifier;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 38
    new-instance v0, Lextern/okhttp3/internal/tls/OkHostnameVerifier;

    invoke-direct {v0}, Lextern/okhttp3/internal/tls/OkHostnameVerifier;-><init>()V

    sput-object v0, Lextern/okhttp3/internal/tls/OkHostnameVerifier;->INSTANCE:Lextern/okhttp3/internal/tls/OkHostnameVerifier;
...
.method public static allSubjectAltNames(Ljava/security/cert/X509Certificate;)Ljava/util/List;
    ...
    invoke-static {p0, v3}, Lextern/okhttp3/internal/tls/OkHostnameVerifier;->getSubjectAltNames(Ljava/security/cert/X509Certificate;I)Ljava/util/List;
...
.method private verifyHostname(Ljava/lang/String;Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-static {p2, v6}, Lextern/okhttp3/internal/tls/OkHostnameVerifier;->getSubjectAltNames(Ljava/security/cert/X509Certificate;I)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v6}, Lextern/okhttp3/internal/tls/OkHostnameVerifier;->verifyHostname(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    new-instance v6, Lextern/okhttp3/internal/tls/DistinguishedNameParser;

    invoke-direct {v6, v4}, Lextern/okhttp3/internal/tls/DistinguishedNameParser;-><init>(Ljavax/security/auth/x500/X500Principal;)V

    const-string v7, "cn"

    invoke-virtual {v6, v7}, Lextern/okhttp3/internal/tls/DistinguishedNameParser;->findMostSpecific(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 90
    invoke-direct {p0, p1, v1}, Lextern/okhttp3/internal/tls/OkHostnameVerifier;->verifyHostname(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private verifyIpAddress(Ljava/lang/String;Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-static {p2, v3}, Lextern/okhttp3/internal/tls/OkHostnameVerifier;->getSubjectAltNames(Ljava/security/cert/X509Certificate;I)Ljava/util/List;
...
.method public verify(Ljava/lang/String;Ljava/security/cert/X509Certificate;)Z
    ...
    .prologue
    .line 57
    invoke-static {p1}, Lextern/okhttp3/internal/Util;->verifyAsIpAddress(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0, p1, p2}, Lextern/okhttp3/internal/tls/OkHostnameVerifier;->verifyIpAddress(Ljava/lang/String;Ljava/security/cert/X509Certificate;)Z
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lextern/okhttp3/internal/tls/OkHostnameVerifier;->verifyHostname(Ljava/lang/String;Ljava/security/cert/X509Certificate;)Z
...
.method public verify(Ljava/lang/String;Ljavax/net/ssl/SSLSession;)Z
    ...
    invoke-virtual {p0, p1, v2}, Lextern/okhttp3/internal/tls/OkHostnameVerifier;->verify(Ljava/lang/String;Ljava/security/cert/X509Certificate;)Z
    :try_end_0
