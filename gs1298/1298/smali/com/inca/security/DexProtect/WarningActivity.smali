...
.method private synthetic IiiiIIIIii()Ljava/lang/String;
    ...
    .line 152
    :try_start_0
    const-string v0, "B>G\"L9G~@?M$F>W~`?M$F(W" #android.content.Context
    ...
    .line 119
    const-string v0, "S/@\u000bD:X#W+@#[$}$R%" #getApplicationInfo #getApplicationInfo
    ...
    .line 130
    const-string v0, "1M4Q?J4\r1S \r\u0011@$J&J$Z" #android.app.Activity
    ...
    .line 32
    const-string v0, "-Q>d+W!U-Q\u0007U$U-Q8" #getPackageManager
    ...
    .line 199
    const-string v2, "B>G\"L9G~@?M$F>W~S=\r\u0000B3H1D5n1M1D5Q" #android.content.pm.PackageManager
    ...
    .line 8
    const-string v3, "-Q>u:D&])U>]%Z\u0006U(Q&" #getApplicationLabel
    ...
    const-string v6, "1M4Q?J4\r3L>W5M$\r N~b S<J3B$J?M\u0019M6L" #android.content.pm.ApplicationInfo
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 117
    const-string v0, "\ubcd7\uc518\u0003\uc845\ucc66p\uc727\ubc48\uc757p\ud0f3\uc990\ub43b\uc5e4\u0003\ud654\uc78fp\uc552\uc714\u0003\uc8d5\ub8ef\ud539\ub2eb\ub2b4\r" #보안 정책 위반이 탐지되어 현재 앱을 종료합니다.
    ...
    .line 97
    const-string v0, "\u5baa\u8895\u5eb7\u7578\u7a28\u5edf\u542d\u7b7c\u4e23\u6b71\u8ff3\u881c\u65d5\u5f95\u9858\u8f8e\u6386\u5260\u7f72\u7e8c\u3021" #安装应用程序后第一次运行时必须连接到网络。
