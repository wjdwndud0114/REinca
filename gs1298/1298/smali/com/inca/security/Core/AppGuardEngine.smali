...
.method public static constructor <clinit>()V
    ...
    .line 76
    const-string v0, "armeabi" #armeabi
...
.method public constructor <init>(Landroid/content/Context;Lcom/inca/security/AppGuard/AppGuardEventListener;Z)V
    ...
    const-string v7, "KH[HLYPZJD]IP_@B[R__@NJ^\\" #DETECT_WEIRD_ROOT_PROCESS
    ...
    const-string v7, "\u0007.\u0017.\u0000?\u001c\"\r=\u0002\'\n/\u001c8\u000e\"\u0017#" #DETECT_INVALID_SMITH #DETECT_INVALID_SMITH
    ...
    const-string v6, "n``!dann#wJn`j" #com.inca.xGame #com.inca.xGame
    ...
    const-string v9, "*3\u001b\u0004\u001e\"\u0019\'#\"\u0018+ &\u0012" #AppGuardHashKey #AppGuardHashKey
    ...
    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder; # full path of libstub

    move-result-object v5

    invoke-virtual {v5}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object v9 # String of full path to libstub.sox

    .line 1095
    const/4 v5, 0x0

    move v6, v5 # v5 is now "/libstub.sox"

    :goto_9
    const/4 v10, 0x3

    if-ge v5, v10, :cond_f # if "/libstub.sox > 3, go to cond_f
    ...
    invoke-direct {v5, v10}, Lcom/inca/security/lb;-><init>(Landroid/content/Context;)V #init decryptor

    .line 1564
    const-string v10, "\u0007*\t0\u001f6\tm\u0018,\u0013" #libstub.sox
                   #v5 = ln instance, v7 = key (?)
    ...
    const/4 v12, 0x0
               #v5 = lb; v10 = libstub.sox; v11 = libstub.so; v12 = 0
    invoke-virtual {v5, v10, v11, v12}, Lcom/inca/security/lb;->IiiiIIIIii(Ljava/lang/String;Ljava/lang/String;[B)Z #Decrypt the file here
    ...
    invoke-static {v11}, Ljava/lang/System;->load(Ljava/lang/String;)V # load libstub

    .line 597
    const/4 v11, 0x1

    invoke-direct/range {p0 .. p1}, Lcom/inca/security/Core/AppGuardEngine;->lllIIIlllI(Landroid/content/Context;)V # first native method
    ...
    const-string v9, "Nck\u007f`dk@ncfkj~{#w`c" #AndroidManifest.xml #AndroidManifest.xml
    ...
    .line 538
    invoke-virtual {v5}, Lcom/inca/security/jc;->start()V #starting MAIN activity
...
.method private synthetic IiiiIIIIii([B)Z
    ...
    invoke-virtual {v4, v0}, Lcom/inca/security/lb;->IiiiIIIIii([B)V # init libengine
    ...
    iget-object v5, p0, Lcom/inca/security/Core/AppGuardEngine;->IIiiIiIIii:Ljava/lang/String; #native method

    const/4 v6, 0x0

    invoke-virtual {v4, v0, v5, v6}, Lcom/inca/security/lb;->IiiiIIIIii(Ljava/lang/String;Ljava/lang/String;[B)Z # Decrypt libengine.sox 2
...
.method public static IiiiIIIIii([BI)[B # native call
    .locals 1
    .param p0, "arg0"    # [B
    .param p1, "arg1"    # I
...
.method public IiiiIIIIii()Ljava/lang/String;
    ...
    const-string v3, "_anyib}`5(k#*i/Ozdci5(w#*u!(w" #Platform:%d.%d Build:%x.%x.%x #Platform:%d.%d Build:%x.%x.%x
...
.method public IiiiIIIIii(Landroid/content/Context;I)V
    ...
    const-string v5, "\"cdmhajfcj#|bw" #/libengine.sox #/libengine.sox
    ...
    const-string v8, "\"cdmhajfcj#|bw" #/libengine.sox #/libengine.sox
    ...
    const-string v6, "\"cdmhajfcj#|bw" #/libengine.sox #/libengine.sox
    ...
    .line 2931
    :try_start_6
    const-string v0, "cdmhajfcj#|bw" #libengine.sox #libengine.sox
    ...
    move-result-object v1 #v1 = full path of libstub.sox as string
    ...
    .line 2750
    const-string v1, "l|~jy|\"n}\u007fjzl}i (|\"cdm~{xm#|bw" #assets/appguard/%s/libstub.sox #assets/appguard/%s/libstub.sox
    ...
    const-string v6, " x\u007finyj#kl{" #/update.dat #/update.dat
    ...
    .line 3170
    const-string v0, "l|~jy|\"n}\u007fjzl}i x\u007finyj#kl{" #assets/appguard/update.dat #assets/appguard/update.dat
    ...
    const-string v3, "cdm~{xm#|bw" #libstub.sox #libstub.sox
...
.method public IiiiIIIIii([BZZ)V
    ...
    const-string v10, "Nck\u007f`dk@ncfkj~{#w`c" #AndroidManifest.xml #AndroidManifest.xml
...
.method public IiiiIIIIii([BZ)Z
    ...
    const-string v4, "nck\u007f`dk#\u007fh}`f~|d`c!LLNJ^\\RAH[Z@_DR\\YNYJ" #android.permission.ACCESS_NETWORK_STATE #android.permission.ACCESS_NETWORK_STATE
...
.method public conditionCallback(II[B)V
    ...
    const-string v11, "7\u000e1\u0006*\u0005\"\u001f&\u000f" #terminated
