.class public Lcom/inca/security/ho;
...
.method public constructor <init>(Lcom/inca/security/Core/AppGuardEngine;)V
    ...
    .prologue
    .line 2643
    iput-object p1, p0, Lcom/inca/security/ho;->IiIiIiiIii:Lcom/inca/security/Core/AppGuardEngine;
...
.method public run()V
    ...
    const-string v3, "1M4Q?J4\r9M$F>W~B3W9L>\r\u001db\u0019m" #android.intent.action.MAIN
    ...
    .line 2086
    const-string v3, "MuHiCrH5EuX~Bo\u0002xMoI|CiU5dTa^" #android.intent.category.HOME
    ...
    :goto_1
    :try_start_2
    const-string v2, "1M4Q?J4\r?P~s\"L3F#P" #android.os.Process
    ...
    .line 2716
    const-string v2, "pEw@K^tO~_h" #killProcess
    ...
    .line 3046
    const-string v2, "FzZz\u0002wMuK5\u007fb_oIv" #java.lang.System
    ...
    :goto_2
    :try_start_3
    iget-object v2, p0, Lcom/inca/security/ho;->IiIiIiiIii:Lcom/inca/security/Core/AppGuardEngine;
