...
.method public synthetic IiiiIIIIii(Lcom/inca/security/uc;)Ljava/lang/String;
    ...
    const-string v3, "#F\"U5Q\u0004Z FpJ#\u0003>V<O" #serverType is null
    ...
    .line 1562
    const-string v3, "S1@;B7F>B=F" #packagename
    ...
    const-string v5, "1M4Q?J4|9G" #android_id
    ...
    .line 1555
    const-string v3, "3F\"W6J>D5Q" #certfinger
    ...
    const-string v5, "`\u0015u\u0015m\u0004|\u0003p\u001c|\u001dj\u0004n\u000fb\u0004w\u0011`\u001b\u000b" #CEVENT_SSL_MITM_ATTACK(
...
.method public synthetic IiiiIIIIii(Landroid/content/Context;I)Z
    ...
    const-string v6, "l\u0007*\t&\u0005$\u0002-\u000em\u0018,\u0013" #/libengine.sox
    ...
    const-string v10, "B S7V1Q4\u000c" #appguard/
    ...
    const-string v9, "l\u0007*\t&\u0005$\u0002-\u000em\u0018,\u0013" #/libengine.sox
    ...
    const-string v7, "B S7V1Q4\u000c" #appguard/
    ...
    .line 261
    :try_start_6
    const-string v1, "\u0007*\t&\u0005$\u0002-\u000em\u0018,\u0013" #libengine.sox
    ...
    .line 315
    const-string v1, "1P#F$P\u007fB S7V1Q4\u000cuP\u007fO9A5M7J>F~P?[" #assets/appguard/%s/libengine.sox
    ...
    const-string v7, "\u007fO9A#W%A~P?[" #/libstub.sox
    ...
    .line 345
    :try_start_e
    const-string v4, "O9A#W%A~P?[" #libstub.sox
    ...
    .line 371
    const-string v4, "\"\u00180\u000e7\u0018l\n3\u001b$\u001e\"\u0019\'Df\u0018l\u0007*\t0\u001f6\tm\u0018,\u0013" #assets/appguard/%s/libstub.sox
    ...
    const-string v4, "B S7V1Q4\u000c%S4B$F~G1W" #appguard/update.dat
    ...
    .line 354
    const-string v1, "\"\u00180\u000e7\u0018l\n3\u001b$\u001e\"\u0019\'D6\u001b\'\n7\u000em\u000f\"\u001f" #assets/appguard/update.dat
    ...
    const-string v3, "O9A5M7J>F~P?[" #libengine.sox
    ...
    const-string v3, "\u0007*\t0\u001f6\tm\u0018,\u0013" #libstub.sox
...
.method public synthetic iIiIIiIIIi()Z
    ...
    const-string v2, "B>G\"L9G~S5Q=J#P9L>\r\u0019m\u0004f\u0002m\u0015w" #android.permission.INTERNET
    ...
    const-string v2, "\n-\u000f1\u0004*\u000fm\u001b&\u0019.\u00020\u0018*\u0004-E\u0002(\u0000.\u00108\u001c%\u0006?\u0014$\u0011 \u001c8\u0017*\u0017." #android.permission.ACCESS_NETWORK_STATE
    ...
    const-string v2, "3L>M5@$J&J$Z" #connectivity
